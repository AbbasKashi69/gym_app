class ResumeVm {
    ...
    late final Null userRegisteryDate;
    ...
    ResumeVm.fromJson(Map<String, dynamic> json){
        ...
        resumeSkills = List.from(json['resumeSkills']).map((e)=>ResumeSkills.fromJson(e)).toList();
        resumeArticles = List.from(json['resumeArticles']).map((e)=>ResumeArticles.fromJson(e)).toList();
        resumeMajors = List.from(json['resumeMajors']).map((e)=>ResumeMajors.fromJson(e)).toList();
        resumeDegrees = List.from(json['resumeDegrees']).map((e)=>ResumeDegrees.fromJson(e)).toList();
        resumeChampionshipTitles = List.from(json['resumeChampionshipTitles']).map((e)=>ResumeChampionshipTitles.fromJson(e)).toList();
        resumeProperties = List.castFrom<dynamic, dynamic>(json['resumeProperties']);
    }
    ...
    Map<String, dynamic> toJson() {
        ...
        _data['resumeChampionshipTitles'] = resumeChampionshipTitles.map((e)=>e.toJson()).toList();
...
class ResumeSkills {
    ...
    late final Null skillDescription;
    late final String creationDate;
    late final String nCreationDate;
...
class ResumeMajors {
    ...
    late final Null majorDescription;
    late final String creationDate;
    late final String nCreationDate;
...
class ResumeChampionshipTitles {
